...
public class Root extends javax.swing.JFrame {
  ...
  private void initComponents() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
          ...
          if (!cliente.getNombre().isEmpty() || !cliente.getNumeroDocumento().isEmpty()) {
            ...
            System.out.println(
                "Debe digitar un nombre y una identificacion para el cliente");
          }
        } catch (Exception e) {
        ...
        try {
          ...
          Clientes clienteGuardado = clienteServ
              .findClientesByIdentificacion(jTextField3.getText());

          pedido.setClientesId(clienteGuardado);
    ...
    jTable1.setModel(new javax.swing.table.DefaultTableModel(
        listarPedidosTabla(),
        new String[] {
            "ID", "NOMBRE", "NRO. DOCUMENTO", "MENU 1", "MENU 2", "MENU 3",
            "MENU 4", "TOTAL"
        }));
    System.out.println(listarPedidosTabla());
