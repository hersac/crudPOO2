...
public class ModalEditarPedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                int cantidadMenu1 = Integer.parseInt(jTextField2.getText());
                int cantidadMenu2 = Integer.parseInt(jTextField3.getText());
                int cantidadMenu3 = Integer.parseInt(jTextField4.getText());
                int cantidadMenu4 = Integer.parseInt(jTextField5.getText());

                actualizarPedido(id, cantidadMenu1, cantidadMenu2, cantidadMenu3, cantidadMenu4);
    ...
    public void actualizarPedido(Long id, int cantidad1, int cantidad2, int cantidad3, int cantidad4) {
        Pedido pedido = new Pedido();
        System.out.println("Este es el ID: "+pedido.getPedidoId());
        pedido.setCantidadMenu1(cantidad1);
        pedido.setCantidadMenu2(cantidad2);
        pedido.setCantidadMenu3(cantidad3);
        pedido.setCantidadMenu4(cantidad4);
        try {
            pedidoService.updatePedido(id, pedido);
            System.out.println("Este es el pedido creado id");
            System.out.println("Se ha actualizado el pedido " + id);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
